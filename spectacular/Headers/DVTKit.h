 ...
 * UUID: 9FA9F506-2F59-3763-BDF3-1959B56DB96C
 * Arch: x86_64
 *       Current version: 2078.0.0, Compatibility version: 1.0.0
...
@interface DVTUndoManager : NSUndoManager <DVTInvalidation_New>
{
    BOOL _isInvalidated;
    BOOL _isInvalidating;
    DVTStackBacktrace *_invalidationBacktrace;
